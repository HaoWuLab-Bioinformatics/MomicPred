...
def main():
    chromsizes = open('./Data_Preparation/mm10.main.nochrM.chrom.sizes')  # positional argument 1 --> chromosome sizes
    folder = os.listdir('./Data_Preparation/GSE_process2')
    bins, valid_chroms = define_bins(chromsizes, resolution)
    for file in folder:
        cell_path = './Data_Preparation/GSE_process2/' + file + '/cell.txt'  # positional argument 3 --> BEDPE file
        out_path = './Data_Preparation/GSE_process3_bin/' + file
